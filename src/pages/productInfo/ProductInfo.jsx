       ...
       <div className='grid grid-cols-2 gap-5 mt-5'>
            ...
            <div className='text-gray-600'>
                ...
                <span className='text-gray-600'>
                    {moment(product.createdAt).format("MM DD YYYY hh:mm A")}
                </span>
            </div>
            {/**details */}
            <div className='flex flex-col gap-3 text-md'>
               ...
               <div className='flex flex-col'>
                  ...
                  <div className='flex justify-between mt-2'>
                     <span>Accessories Avalable</span>
                     <span>${product.accessoriesAvalable ? "Yes":"No"}</span>
                  </div>
                  <div className='flex justify-between mt-2'>
                     <span>Warranty Avalable</span>
               ...
               return(
                  <div className='border border-gray-300 border-solid p-3 rounded mt-5'>
                     ...
                     <div className='flex justify-between mt-2 text-gray-600 '>
                         ...
                         <span>
                           (" ")
                            {moment(bid.createdAt).format("MM DD YYYY hh:mm A")}
                           </span>
                     </div>
                  </div>
               )
